...
export const ADMIN_ACCOUNT_PAGE = 'accounts';
...
export const CUSTOMER_APPOINTMENTS = 'customer-appointments';
...
export const APPOINTMENT_EDIT_DETAILS = 'appointment-edit-details';

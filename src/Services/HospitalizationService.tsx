...
export const hospitalizationListVetAPI = async (vetName: string) => {
  try {
    const response = await axiosInstance.get<Hospitalization[]>(api + `/Hospitalization/VetName${vetName}`);
...
export const hospitalizationUpdateAPI = async (hospitalizationId: number, dischargeDate: string) => {
  try {

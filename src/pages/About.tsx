...
const Section = ({
  ...
  <section className='bg-[var(--background)] py-2'>
    <div className='container mx-auto text-center'>
      <h2 className='text-4xl md:text-5xl font-bold mb-12 text-shadow'>{title}</h2>
          ...
          <div className='flex flex-col md:flex-row items-center justify-center'>
            <div className='mb-8 md:mb-0'>
              ...
              <p className='text-lg md:text-[1.4rem] text-[--hero-text] mb-8 mt-[3rem] text-center font-roboto'>
                Welcome to our pet care service! We're dedicated to top-tier care for your furry friends, ensuring
                they're happy, healthy, and safe.
              </p>
              <img src={hero} alt='Hero' className='w-[110rem] h-auto mt-[5rem] rounded-lg' />
            </div>
          </div>
        </div>
      </section>

...
const KennelPage: React.FC = () => {
  ...
  return (
    <div className='p-6'>
      <Button onClick={() => navigate(-1)} className='mb-4 bg-gray-800 text-white'>
        Go Back
      </Button>
      ...
      <div className={`shadow-md rounded-lg p-6`}>
        ...
        <p className='text-lg font-semibold mb-2'>Description: {kennelDetails.description}</p>
        <p className='text-lg font-semibold mb-2'>Daily Cost: ${kennelDetails.dailyCost.toFixed(2)}</p>
      </div>
    </div>
  )
}

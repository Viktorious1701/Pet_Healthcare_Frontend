  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-100'>
      <Card className='w-full max-w-md p-4 shadow-lg'>
        <Card.Body>
          <Card.Title className='mb-4 text-center text-2xl font-bold text-custom-pink'>Cancel Appointment</Card.Title>
          <Wrapper>
          ...
          <p className='text-center mb-4'>If you cancel your appointment:</p>

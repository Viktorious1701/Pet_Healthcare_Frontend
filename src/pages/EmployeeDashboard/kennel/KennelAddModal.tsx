...
const KennelAddModal: React.FC<KennelAddModalProps> = ({ onKennelAdded }) => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose} onOpenChange={onOpenChange} placement='top-center'>
        <ModalContent>
          {(onClose) => (
            <form onSubmit={handleSubmit(onSubmit)}>
              <ModalHeader className='flex flex-col gap-1'>Add a new kennel</ModalHeader>
              <ModalBody>
                <Input
                  autoFocus
                  endContent={<BookText className='text-2xl text-default-400 pointer-events-none flex-shrink-0' />}
                  label='Description'
                ...
                <Input
                  endContent={<MemoryStick className='text-2xl text-default-400 pointer-events-none flex-shrink-0' />}
                  label='Capacity'
                ...
                <Input
                  endContent={<DollarSign className='text-2xl text-default-400 pointer-events-none flex-shrink-0' />}
                  label='Daily Cost'

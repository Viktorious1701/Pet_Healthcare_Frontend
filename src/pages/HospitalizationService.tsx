          ...
          <section id="services-details" className="mt-[4rem] flex justify-center items-center gap-8">
            ...
            <ImageCard imgSrc={petcare}>
              ...
              <div className="space-x-4 mt-4">
                <h4>Our team is dedicated to providing around-the-clock care to monitor your pet's health status continuously.</h4>
              </div>
            </ImageCard>
            <ImageCard imgSrc={petcare}>
              <h3 className="text-xl font-bold mb-2">Advanced Medical Equipment</h3>
              <div className="space-x-4 mt-4">
                <h4>We utilize the latest medical technology to ensure accurate diagnostics and effective treatment plans.</h4>
              </div>
            </ImageCard>
            </div>
            <div className="flex flex-col gap-[4rem]">
            ...
            <ImageCard imgSrc={petcare}>
              ...
              <div className="space-x-4 mt-4">
                <h4>Our facilities are designed to offer a comfortable and stress-free environment for your pet's recovery.</h4>
              </div>
            </ImageCard>
            </div>
          </section>

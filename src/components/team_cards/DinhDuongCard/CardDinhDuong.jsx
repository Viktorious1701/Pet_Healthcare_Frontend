...
useGLTF.preload('https://storage.googleapis.com/pet88/tagDinhDuong.glb');
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const { nodes, materials } = useGLTF(
    "https://storage.googleapis.com/pet88/tagDinhDuong.glb"
  );
...
export default function CardDinhDuong() {
